...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast("Failed to log in. Please check your credentials.", "error");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 sm:p-12 md:p-24 bg-background">
        <div className="max-w-md w-full mx-auto">
          <h2 className="text-4xl font-sans font-bold uppercase tracking-tight mb-2">Welcome Back</h2>
          <p className="text-muted font-mono mb-8">Access your secure image vault.</p>
          ...
          <p className="text-center font-mono font-bold text-dark">
            ...
            <Link href="/signup" className="text-primary hover:underline underline-offset-4 pointer-events-auto">
              Sign up
            </Link>
          </p>
        </div>
